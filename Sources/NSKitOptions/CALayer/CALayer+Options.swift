...
public extension CALayer
{
    ...
    enum Option
    {
        ...
        // MARK: - Convenience
        public static func borderColor(_ color: NSColor) -> Self
        {
            .borderColor(color.cgColor)
        }
        
        public static func backgroundColor(_ color: NSColor) -> Self
        {
            .backgroundColor(color.cgColor)
        }
        
        public static func shadowColor(_ color: NSColor) -> Self
        {
